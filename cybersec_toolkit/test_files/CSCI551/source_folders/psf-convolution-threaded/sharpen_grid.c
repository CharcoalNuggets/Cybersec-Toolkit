...
#define IMG_HEIGHT (960)//changed image dimensions to match the 1280x960 requirement    -dg
...
{
    int fdin, fdout, bytesRead=0, bytesWritten=0, bytesLeft, i, j, idx, jdx, pixel, readcnt, writecnt, it;
...
for(it = 0; it < 5; it++){//repeat 5 times
